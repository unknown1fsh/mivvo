...
export async function generateMetadata({ params }: { params: { id: string } }) {
  const mockReports: { [key: string]: DetailedReport } = {
    '1': {
      ...
      overallScore: 87,
      sections: {
        exterior: { score: 92, paintCondition: 'Mükemmel', scratches: 2, dents: 0, rust: false, oxidation: 5, glossLevel: 95, recommendations: [] },
        interior: { score: 85, seatCondition: 'İyi', dashboardCondition: 'Mükemmel', electronicsWorking: true, cleanliness: 'Temiz', recommendations: [] },
        mechanical: { score: 90, engineCondition: 'Mükemmel', transmissionCondition: 'İyi', brakesCondition: 'Mükemmel', suspensionCondition: 'İyi', recommendations: [] },
        safety: { score: 88, airbagStatus: 'Aktif', absWorking: true, seatbeltCondition: 'İyi', lightsWorking: true, recommendations: [] }
      },
      marketValue: { estimatedValue: 485000, marketRange: { min: 460000, max: 510000 }, depreciation: 12, comparison: 'Piyasa ortalamasının üzerinde' },
      summary: { strengths: [], weaknesses: [], overallRecommendation: 'Satın alınabilir', priorityActions: [] }
    },
    '2': {
      id: '2',
      vehicleInfo: {
      ...
      overallScore: 78,
      sections: {
        exterior: { score: 75, paintCondition: 'İyi', scratches: 8, dents: 3, rust: false, oxidation: 15, glossLevel: 70, recommendations: [] },
        interior: { score: 80, seatCondition: 'İyi', dashboardCondition: 'İyi', electronicsWorking: true, cleanliness: 'Orta', recommendations: [] },
        mechanical: { score: 82, engineCondition: 'İyi', transmissionCondition: 'İyi', brakesCondition: 'İyi', suspensionCondition: 'İyi', recommendations: [] },
        safety: { score: 85, airbagStatus: 'Aktif', absWorking: true, seatbeltCondition: 'İyi', lightsWorking: true, recommendations: [] }
      },
      marketValue: { estimatedValue: 425000, marketRange: { min: 400000, max: 450000 }, depreciation: 18, comparison: 'Piyasa ortalamasında' },
      summary: { strengths: [], weaknesses: [], overallRecommendation: 'Pazarlık yapılabilir', priorityActions: [] }
    }
  }
