...
export default function RegisterPage() {
  ...
  const { signInWithGoogle, signInWithFacebook } = useNextAuth()
  ...
  const handleFacebookSignIn = async () => {
    try {
      await signInWithFacebook('/dashboard')
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="card p-8">
          ...
          {/* Email Verification Notice - GEÇİCİ OLARAK DEVRE DIŞI */}
          {false && (
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-1 text-sm text-blue-700">
                    <p>
                      Kayıt işlemi sonrası email adresinize doğrulama linki gönderilecektir. 
