...
export function AudioReport({ data, vehicleInfo, vehicleImages = [], showActions = false }: AudioReportProps) {
  // Veri kontrolü - AI analiz verisi eksikse hata göster
  if (!data || !data.overallScore || !data.engineHealth || !data.rpmAnalysis || !data.soundQuality || 
          ...
          <div className="text-center">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6 text-left">
              ...
              <p className="text-gray-600 text-sm">
                Motor sesi analizi verileri eksik veya AI servisinden veri alınamadı. Bu durum genellikle geçici bir sorundur.
              </p>
            </div>
