...
export function DamageReport({ data, vehicleInfo, vehicleImages = [], showActions = false }: DamageReportProps) {
          ...
          <div className="text-center">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6 text-left">
              ...
              <p className="text-gray-600 text-sm">
                Hasar analizi verileri henüz yüklenmedi veya AI servisinden veri alınamadı. 
                Bu durum genellikle geçici bir sorundur.
              </p>
            </div>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-2xl w-full bg-white rounded-lg shadow-lg border-2 border-red-200 p-8">
          <div className="text-center">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6 text-left">
              <p className="text-gray-800 font-medium mb-2">
                ⚠️ AI Servisinden Eksik Veri Geldi
              </p>
              <p className="text-gray-600 text-sm">
                AI analiz sonucu eksik veya geçersiz formatında geldi. Bu durum AI servisinin geçici olarak 
                yanıt veremediğini gösterir. Lütfen daha sonra tekrar deneyin.
              </p>
            </div>
            <div className="bg-green-50 border-l-4 border-green-400 p-4 mb-6 text-left">
              <p className="text-green-800 font-medium mb-2">
